...
PINNED = {
    ...
    #: move.
    #: 39 / 38 / 1 / 13 / 2 SINCE LANE L5'S MERGE (sum 93, `gap_read`):
    #: `M M49` left bucket 3 for COVERED-UNFIRED, ADMITTED; the boundary did
    #: not move.
    "b3_admitted": 39,
    "b3_refused": 38,
    "b3_no_address": 1,
    ...
    #:                        (+4 none).
    #:   lane L5's merge      12 standing / 0 / 0 / 21 none, 6 released, of 33:
