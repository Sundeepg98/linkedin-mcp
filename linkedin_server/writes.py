...
SANCTIONED_WRITES: dict[str, WriteSpec] = {
    ...
    "linkedin_update_profile_field": WriteSpec(
        ...
        reversible_by=(
            ...
            "AND THE SECOND CLAUSE WAS FALSE TOO. It said '/edit/' is on the "
            "read boundary's forbidden list \"so it cannot reach the editor in "
            "either direction\". The SUBSTRING is forbidden in general; THIS "
            "EXACT URL is an exemption, which is how the editor is read at "
            "all. "
