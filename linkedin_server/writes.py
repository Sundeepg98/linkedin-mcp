...
_NINE_REFUSALS: dict[str, str] = {
    ...
    "comment_on_item": (
        ...
        "anything is posted. WHAT WOULD LIFT IT: a sanctioned text-entry "
        "mutation. The surface, the anchor and the aim are all in hand."
    ),
    "react_to_item": (
        ...
        "beside the toggle, aria-expanded='false', count 1 on the permalink "
        "too, and its contents have never been observed; whether pressing the "
        "toggle applies a default Like or opens that picker has never been "
        "established. A gate that cannot say what it is about to express "
    ...
    "send_message": (
        ...
        "NOT ON THIS PAGE: the control named 'InMail' is a conversation-list "
        "FILTER PILL carrying aria-checked=false, sitting beside 'Focused', "
        "'Unread', 'Starred' and 'Connections' -- it is not a credit count, "
        "and reading a balance would need /premium/my-premium/, which the "
        "operator has admitted and which nobody has loaded. WHAT STOPS IT: "
        "SENDING MEANS TYPING, and no text-entry mutation is sanctioned "
        "anywhere in this package. AND WHAT MUST BE TRUE BEFORE IT SHIPS "
        ...
        "cost. So its preview must either report the balance or say plainly "
        "that the balance could not be read and that the send may spend a "
        "credit. Reporting nothing is not an option. WHAT WOULD LIFT IT: a "
        "sanctioned text-entry mutation, and the balance read or its absence "
        "stated."
    ),
