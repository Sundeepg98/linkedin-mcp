...
## 24. The names-that-do-not-exist wave, 2026-09-20

### 24.1 `scripts/check_asserted_names_resolve.py` -- A NAME AN AUDIT DOCUMENT ASSERTS MUST RESOLVE
...
### 24.2 A GUARD CAN DISARM ITSELF BY DOCUMENTING ITSELF
...
### 24.3 A UNION CLAIM OVER A REDUNDANT CORPUS CANNOT SEE A NARROWING
...
### 24.4 A MECHANISM THAT IS CORRECT AND LOAD-BEARING NOWHERE
...
### 24.5 TWO NUMBERS THIS WAVE GOT WRONG, BOTH CAUGHT BY A READER
