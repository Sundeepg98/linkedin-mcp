...
**Measured 2026-09-20:** 79 banked rows, 87 cited artifacts, **7 rows** resting
on at least one unreachable artifact, **0** with no reachable artifact at all,
13 unreachable artifacts and all 13 are `_audit/_scratch/` paths. 24 further
rows describe a live run with no tracked script, reported separately as the
softer number it is.
