...
**CORRECTED BY:** `_audit/2026-09-23-exclusion-returns.md` -- lane R returned 75 of this slice's 97 exclusions to GAP with each blocker named, moved N 23 to COVERED-UNFIRED because linkedin_connections reads that list, and kept 21 on the census's written grounds; GAP 86 -> 161.
...
call was the orchestrator's, delegated under OUTWARD-ACTS-NEED-THE-OPERATOR.
    ...
    GAP               86  ->  161   75 returned
    EXCLUDED-RULED    97  ->   21   kept, see below
...
| 35 | Unfollow a person from their profile | W | GAP | R4. REV **RETURNED TO GAP 2026-09-23 BY LANE R (2026-09-23-exclusion-returns.md s3.6), on the orchestrator's delegated call, not a new ruling.** BLOCKER, NAMED: the only route the census names is the member's own profile page, which the operator's 2026-09-04 ruling removed from the boundary (a profile load leaves the member a viewer record); a route from a surface the boundary admits is unmeasured; the same unfollow is reachable from the people-follow list (N 38), itself refused by the "/follow" class filter. |
...
| 66 | Follow an interest from another member's Interests section | W | GAP | R4 **RETURNED TO GAP 2026-09-23 BY LANE R (2026-09-23-exclusion-returns.md s3.6), on the orchestrator's delegated call, not a new ruling.** BLOCKER, NAMED: the only route the census names is the member's own profile page, which the operator's 2026-09-04 ruling removed from the boundary (a profile load leaves the member a viewer record); a route from a surface the boundary admits is unmeasured; following a company this way is the same follow linkedin_follow_company ships. |
...
| 144 | Report a member's profile | W | GAP | R4. NOT-REV **RETURNED TO GAP 2026-09-23 BY LANE R (2026-09-23-exclusion-returns.md s3.6), on the orchestrator's delegated call, not a new ruling.** BLOCKER, NAMED: the only route the census names is the member's own profile page, which the operator's 2026-09-04 ruling removed from the boundary (a profile load leaves the member a viewer record); a route from a surface the boundary admits is unmeasured. A report accuses another member: the narrative and the target are his, fired only on his word. |
| 145 | Report a fake or impersonating profile | W | GAP | R4. NOT-REV **RETURNED TO GAP 2026-09-23 BY LANE R (2026-09-23-exclusion-returns.md s3.6), on the orchestrator's delegated call, not a new ruling.** BLOCKER, NAMED: the only route the census names is the member's own profile page, which the operator's 2026-09-04 ruling removed from the boundary (a profile load leaves the member a viewer record); a route from a surface the boundary admits is unmeasured. A report accuses another member: the narrative and the target are his, fired only on his word. |
| 146 | Report inaccurate information on another member's profile | W | GAP | R4. NOT-REV **RETURNED TO GAP 2026-09-23 BY LANE R (2026-09-23-exclusion-returns.md s3.6), on the orchestrator's delegated call, not a new ruling.** BLOCKER, NAMED: the only route the census names is the member's own profile page, which the operator's 2026-09-04 ruling removed from the boundary (a profile load leaves the member a viewer record); a route from a surface the boundary admits is unmeasured. A report accuses another member: the narrative and the target are his, fired only on his word. |
| 147 | Report a profile video | W | GAP | R4. NOT-REV **RETURNED TO GAP 2026-09-23 BY LANE R (2026-09-23-exclusion-returns.md s3.6), on the orchestrator's delegated call, not a new ruling.** BLOCKER, NAMED: the only route the census names is the member's own profile page, which the operator's 2026-09-04 ruling removed from the boundary (a profile load leaves the member a viewer record); a route from a surface the boundary admits is unmeasured. A report accuses another member: the narrative and the target are his, fired only on his word. |
