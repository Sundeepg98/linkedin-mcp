...
| 114 | Hide or show an endorsement you received from a particular member | W | GAP | REV. **Lives on HIS OWN skills page, which IS readable** (`/in/me/details/skills/`). R3 governs endorsing others, not managing what he received. Nothing written covers the receiving side **LANE L7, 2026-09-24 -- VISIBLE-TO-OTHERS, BLOCKED.** The same capability as profile `E6`, and blocked the same two ways: no endorsement is drawn on his skills page (row `118`), and a per-skill endorsers address carries `/endorse`. Its live proof would need the endorsement HE names. Record: `_audit/2026-09-24-lane-l7-profile-writes.md`, section 6. |
...
| 176 | Prevent your network being updated when you join a group | W | GAP | REV **LANE L7, 2026-09-24 -- SELF-PRIVATE, BLOCKED.** It reduces what others are told. Its only route, measured 2026-09-05, is each membership row's 'Update your settings' anchor to `/psettings/group/<id>`, which meets two forbidden substrings and is a persisted preference that the ruling MESSAGING-SETTINGS-CAPABILITY-LEVEL admits by name or not at all; row `170`, on the same page, is EXCLUDED-RULED by propagation. Whether this row follows it is raised for the exclusions owner, not ruled here. Record: `_audit/2026-09-24-lane-l7-profile-writes.md`, section 6. |
