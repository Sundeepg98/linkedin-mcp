...
| 20 | Be notified when a member invites you to connect | R | **COVERED-UNFIRED** | `linkedin_notifications`. **HELD BY `NOTIFICATIONS-UNREAD-SPEND`** (2026-09-23) -- an OPEN QUESTION to the operator, not a ruling. Loading `/notifications/` clears his unread badge and it does not come back (measured 1 -> 0 on 2026-08-21, stated in the tool's own docstring), so a fire spends his state; and it proves this row only if an invitation-kind item is in his list that day. Priced, and put to him, in `_audit/2026-09-23-bucket1-fires.md` sections 2 and 5 |
...
| 45 | Be notified when a non-connection follows you | R | **COVERED-UNFIRED** | `linkedin_notifications`. **HELD BY `NOTIFICATIONS-UNREAD-SPEND`** (2026-09-23) -- an OPEN QUESTION to the operator, not a ruling. Loading `/notifications/` clears his unread badge and it does not come back (measured 1 -> 0 on 2026-08-21, stated in the tool's own docstring), so a fire spends his state; and it proves this row only if a follow-kind item is in his list that day. Priced, and put to him, in `_audit/2026-09-23-bucket1-fires.md` sections 2 and 5 |
