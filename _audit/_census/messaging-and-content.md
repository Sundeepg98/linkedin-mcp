...
> |---|---|
> | the read allowlist is **22** url patterns | **41**. Twenty of the listed twenty-two survive; **two were deliberately DROPPED** -- the generic `/in/<slug>/` pair went at `956358d` on 2026-09-04, so no pattern today can address a third party's profile by slug at all -- and **21 were added** |
