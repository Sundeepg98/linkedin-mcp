...
| G2 | Activity section default view | W | GAP | no tool, no reason **LANE L7, 2026-09-24 -- SELF-PRIVATE, NEEDS-CAPTURE.** Which activity type visitors see first on his profile: a display preference, nobody targeted, reversible. Its control is an ANCHOR on his profile render, 'Edit default activity', to `/in/me/edit/forms/content-collections-star-pill/new/` -- refused by `/edit/` today, admissible under the ruling PROFILE-EDITOR-ADDRESSES-ALLOWED. Lifted by capture C4 (that exact address admitted; one navigation; the options, which is checked, its Save; no press). Record: `_audit/2026-09-24-lane-l7-profile-writes.md`, section 6. |
...
|---|---|---|---|---|
| H1 | Create a Service Page / add services | W | GAP | one of the three items the `Open to` menu resolves to on his account; never actioned **LANE L7, 2026-09-24 -- VISIBLE-TO-OTHERS, NEEDS-CAPTURE.** A Service Page is a public listing clients can act on; its content is his to name. Its entry is an ANCHOR, `/in/me/opportunities/services/education/` ('Showcase your services ... Add services', also in the tracked `profile_topcard_hydrated.html`), refused by the read boundary today. Lifted by capture C3. Record: `_audit/2026-09-24-lane-l7-profile-writes.md`, section 6. |
