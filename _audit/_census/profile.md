...
| F2 | Request a recommendation | W | EXCLUDED-RULED | **EXCLUDED-RULED 2026-09-19 by PROPAGATION, not a new decision.** Named in `PERMANENTLY_FORBIDDEN["endorse_or_recommend"]`, the same key this slice already cites on `F3`/`F4`/`F5`. Twin `N119` -- *Request a recommendation from a 1st-degree connection* -- is EXCLUDED-RULED under `network.md` **R3**, whose own row list enumerates 119-128. **The control is inside this block:** three of its eight recommendation writes already carried the ruling and five did not, so the split is not a slice-wide difference. R3's basis is a MEASUREMENT rather than a policy -- zero endorse controls across 13 tracked fixtures, zero on his own skills surface, zero among 222 controls read live. Prior note kept: no tool, no reason; it reaches another member |
...
| F6 | Accept or dismiss a recommendation received | W | EXCLUDED-RULED | **EXCLUDED-RULED 2026-09-19 by PROPAGATION, not a new decision.** Named in `PERMANENTLY_FORBIDDEN["endorse_or_recommend"]`, the same key this slice already cites on `F3`/`F4`/`F5`. Twin `N121 + N122` -- *Accept / Dismiss a recommendation you received* -- is EXCLUDED-RULED under `network.md` **R3**, whose own row list enumerates 119-128. **The control is inside this block:** three of its eight recommendation writes already carried the ruling and five did not, so the split is not a slice-wide difference. R3's basis is a MEASUREMENT rather than a policy -- zero endorse controls across 13 tracked fixtures, zero on his own skills surface, zero among 222 controls read live. Prior note kept: no tool, no reason |
| F7 | Ask for a revision of one received | W | EXCLUDED-RULED | **EXCLUDED-RULED 2026-09-19 by PROPAGATION, not a new decision.** Named in `PERMANENTLY_FORBIDDEN["endorse_or_recommend"]`, the same key this slice already cites on `F3`/`F4`/`F5`. Twin `N123` -- *Ask for a revision of a recommendation you received* -- is EXCLUDED-RULED under `network.md` **R3**, whose own row list enumerates 119-128. **The control is inside this block:** three of its eight recommendation writes already carried the ruling and five did not, so the split is not a slice-wide difference. R3's basis is a MEASUREMENT rather than a policy -- zero endorse controls across 13 tracked fixtures, zero on his own skills surface, zero among 222 controls read live. Prior note kept: no tool, no reason |
| F8 | Decline a requested recommendation | W | EXCLUDED-RULED | **EXCLUDED-RULED 2026-09-19 by PROPAGATION, not a new decision.** Named in `PERMANENTLY_FORBIDDEN["endorse_or_recommend"]`, the same key this slice already cites on `F3`/`F4`/`F5`. Twin `N128` -- *Decline a recommendation request someone sent you* -- is EXCLUDED-RULED under `network.md` **R3**, whose own row list enumerates 119-128. **The control is inside this block:** three of its eight recommendation writes already carried the ruling and five did not, so the split is not a slice-wide difference. R3's basis is a MEASUREMENT rather than a policy -- zero endorse controls across 13 tracked fixtures, zero on his own skills surface, zero among 222 controls read live. Prior note kept: no tool, no reason |
| F9 | Hide / unhide recommendations on the profile | W | EXCLUDED-RULED | **EXCLUDED-RULED 2026-09-19 by PROPAGATION, not a new decision.** Named in `PERMANENTLY_FORBIDDEN["endorse_or_recommend"]`, the same key this slice already cites on `F3`/`F4`/`F5`. Twin `N126` -- *Hide or unhide a recommendation you received* -- is EXCLUDED-RULED under `network.md` **R3**, whose own row list enumerates 119-128. **The control is inside this block:** three of its eight recommendation writes already carried the ruling and five did not, so the split is not a slice-wide difference. R3's basis is a MEASUREMENT rather than a policy -- zero endorse controls across 13 tracked fixtures, zero on his own skills surface, zero among 222 controls read live. Prior note kept: no tool, no reason |
...
| N20 | Calendar sync | W | EXCLUDED-RULED | settings family -- ruling: `linkedin_update_setting` (`linkedin_server/server.py`), *"a setting is admitted by name or not at all"*; the SAME ruling as `network.md` **R11** and messaging **MESSAGING-SETTINGS** (3.10); mobile app only |
